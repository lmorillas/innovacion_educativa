...
PILDORAS = [{'email': None,
  'nombre': 'Flipped Classroom',
  'observaciones': None,
  'procedencia': 'CRA Pablo Antonio Crespo. Colegio de Camarillas (Teruel)',
  'quien': 'Javier Castillo'},
 {'email': '  diegoarroyom@gmail.com',
  'nombre': 'Visual Thinking',
  'observaciones': None,
  'procedencia': 'CIFE JL',
  'quien': 'Diego Arrollo Murillo'},
 {'email': None,
  'nombre': 'Cuadernos inteligentes (en inglés)',
  'observaciones': None,
  'procedencia': 'belenembid80@gmail.com',
  'quien': ' Belén Embid Dieste (CIFE MA)'},
 {'email': None,
  'nombre': 'Método ABN',
  'observaciones': None,
  'procedencia': None,
  'quien': 'CEIP Torreramona   '},
 {'email': None,
  'nombre': 'Átlas escolar',
  'observaciones': None,
  'procedencia': None,
  'quien': 'Javier Velilla'},
 {'email': 'pabloruizsoria@gmail.com',
  'nombre': 'Trivinet',
  'observaciones': None,
  'procedencia': 'IES Ángel Sanz Briz',
  'quien': 'Pablo Ruiz Soria'},
 {'email': None,
  'nombre': 'Kahoot',
  'observaciones': None,
  'procedencia': 'IES Ródenas',
  'quien': 'Jorge Ortigas'},
 {'email': None,
  'nombre': 'Arduino',
  'observaciones': None,
 ...
 {'email': '',
  ...
  'observaciones': 'Los participantes deberán llevar descargada en el móvil la '
                   'app gratuita Aurasma.',
  'procedencia': '',
  'quien': ''},
 {'email': None,
  'nombre': 'Samsung',
  ...
  'quien': None},
 {'email': None,
  'nombre': 'Realidad virtual: Google',
  'observaciones': None,
  'procedencia': None,
  'quien': None},
 {'email': None,
